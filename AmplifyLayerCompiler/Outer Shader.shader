...
Shader "Outer Shader"
{
	Properties
	{
		...
		[Toggle(_ENABLELAYER)] _EnableLayer("Enable Layer", Float) = 0
		_BaseMap1("BaseMap1", 2D) = "black" {}
		_Opacity1("Opacity1", Range( 0 , 1)) = 0
		[Toggle(_ENABLELAYER1)] _EnableLayer("Enable Layer", Float) = 0
		_BaseMap2("BaseMap2", 2D) = "black" {}
		_Opacity2("Opacity2", Range( 0 , 1)) = 0
		[Toggle(_ENABLELAYER2)] _EnableLayer("Enable Layer", Float) = 0
		_BaseMap3("BaseMap3", 2D) = "black" {}
		_Opacity3("Opacity3", Range( 0 , 1)) = 0
		[ASEEnd][Toggle(_ENABLELAYER3)] _EnableLayer("Enable Layer", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _ENABLELAYER3
			#pragma shader_feature_local _ENABLELAYER2
			#pragma shader_feature_local _ENABLELAYER1
			#pragma shader_feature_local _ENABLELAYER
						 ...
						 ) : SV_Target
			{
				...
				float4 temp_output_1_0_g1 = color8;
				float2 uv_BaseMap = IN.ase_texcoord7.xy * _BaseMap_ST.xy + _BaseMap_ST.zw;
				#ifdef _ENABLELAYER
				float4 staticSwitch17_g1 = ( temp_output_1_0_g1 + ( tex2D( _BaseMap, uv_BaseMap ) * _Opacity ) );
				#else
				float4 staticSwitch17_g1 = temp_output_1_0_g1;
				#endif
				float4 temp_output_1_0_g2 = staticSwitch17_g1;
				float2 uv_BaseMap1 = IN.ase_texcoord7.xy * _BaseMap1_ST.xy + _BaseMap1_ST.zw;
				#ifdef _ENABLELAYER1
				float4 staticSwitch17_g2 = ( temp_output_1_0_g2 + ( tex2D( _BaseMap1, uv_BaseMap1 ) * _Opacity1 ) );
				#else
				float4 staticSwitch17_g2 = temp_output_1_0_g2;
				#endif
				float4 temp_output_1_0_g3 = staticSwitch17_g2;
				float2 uv_BaseMap2 = IN.ase_texcoord7.xy * _BaseMap2_ST.xy + _BaseMap2_ST.zw;
				#ifdef _ENABLELAYER2
				float4 staticSwitch17_g3 = ( temp_output_1_0_g3 + ( tex2D( _BaseMap2, uv_BaseMap2 ) * _Opacity2 ) );
				#else
				float4 staticSwitch17_g3 = temp_output_1_0_g3;
				#endif
				float4 temp_output_1_0_g4 = staticSwitch17_g3;
				float2 uv_BaseMap3 = IN.ase_texcoord7.xy * _BaseMap3_ST.xy + _BaseMap3_ST.zw;
				#ifdef _ENABLELAYER3
				float4 staticSwitch17_g4 = ( temp_output_1_0_g4 + ( tex2D( _BaseMap3, uv_BaseMap3 ) * _Opacity3 ) );
				#else
				float4 staticSwitch17_g4 = temp_output_1_0_g4;
				#endif
				
				float3 Albedo = staticSwitch17_g4.rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				#endif
				float4 temp_output_1_0_g2 = staticSwitch17_g1;
				float2 uv_BaseMap1 = IN.ase_texcoord2.xy * _BaseMap1_ST.xy + _BaseMap1_ST.zw;
				#ifdef _ENABLELAYER1
				float4 staticSwitch17_g2 = ( temp_output_1_0_g2 + ( tex2D( _BaseMap1, uv_BaseMap1 ) * _Opacity1 ) );
				#else
				float4 staticSwitch17_g2 = temp_output_1_0_g2;
				#endif
				float4 temp_output_1_0_g3 = staticSwitch17_g2;
				float2 uv_BaseMap2 = IN.ase_texcoord2.xy * _BaseMap2_ST.xy + _BaseMap2_ST.zw;
				#ifdef _ENABLELAYER2
				float4 staticSwitch17_g3 = ( temp_output_1_0_g3 + ( tex2D( _BaseMap2, uv_BaseMap2 ) * _Opacity2 ) );
				#else
				float4 staticSwitch17_g3 = temp_output_1_0_g3;
	...
	/*ase_lod*/
	CustomEditor "AmplifyShaderEditorGUI"
	Fallback "Hidden/InternalErrorShader"
	
}
/*ASEBEGIN
Version=18912
0;72.57143;2193;1081;1068.286;559.0712;1;True;False
Node;AmplifyShaderEditor.ColorNode;8;-603,-101;Inherit;False;Constant;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;26;-352,-96;Inherit;False;Test Layer 0;0;;1;9b1b0a800b2131f429b2b5f934a202d0;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;27;-144,-96;Inherit;False;Test Layer 1;4;;2;b734366a236ee864093f142bc19aa51c;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;28;64,-96;Inherit;False;Test Layer 2;8;;3;21c1f8d0d9a067b438fb23db80b61ef1;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;29;272,-96;Inherit;False;Test Layer 3;12;;4;e0bec7bc15ef0a84481c184afc79f4bb;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;496,-96;Float;False;True;-1;2;AmplifyShaderEditorGUI;0;2;Outer Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Write Depth;0;  Early Z;0;Vertex Position,InvertActionOnDeselection;1;0;8;False;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.CommentaryNode;13;-388.286,-307.9283;Inherit;False;854;124;Every property and keyword in each of these usages of the same layer become a unique instance.;0;;1,1,1,1;0;0
...
ASEEND*/
//CHKSM=30AAC02823921790CC1A707934F9D0EA3F0FF87B